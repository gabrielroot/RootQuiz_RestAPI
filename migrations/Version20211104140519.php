 ...
 */
final class Version20211104140519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE respostas (id INT NOT NULL, alternativa VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
